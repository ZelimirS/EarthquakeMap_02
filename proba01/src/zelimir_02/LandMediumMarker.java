...
public class LandMediumMarker extends LandMarker {
	
	PApplet pApp = new PApplet();
	PImage image = pApp.loadImage("data/ui/land_yellow.png");
	HashMap<String, Object> properties;

	public LandMediumMarker(Location loc, HashMap<String, Object> properties) {
